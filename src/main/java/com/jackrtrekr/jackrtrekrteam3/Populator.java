...
//        Continent: Asia
        ...
        Trek theOceanEndeavour = new Trek("The Ocean Endeavour", "Explore the natural environment and closeup encounters with wildlife on our forward-facing zodiac’s and on foot.", antarctica, southPole, difficult, "Raft, Water bottle, Food, Head Lamp", "Eleven days");
        trekRepo.save(theOceanEndeavour);

        //      Continent: Africa
        Trek mountKilimanjaro = new Trek ("Mount Kilimanjaro", "The highest mountain in Africa—rising to 5,895 more than 19,000 feet in elevation.", africa, savanna, moderate, "Water Bottle, Sleeping bag, Sunglasses, Sunscreen, Hat or Visor","Three to Five days");
        trekRepo.save(mountKilimanjaro);

        Trek maasaiMara = new Trek("Maasai Mara.", "The Maasai Mara offers several cross-counrty tours. It is all across flat lands.", africa, southernAfrica, moderate,"Water Bottle, Sleeping bag, Sunglasses, Sunscreen, Hat or Visor", "Five to seven days");
        ...
        Trek livingstonia = new Trek("Livingstonia", "Livingstonia is 900 meters above the lake and is accessible by either driving up hairpin African dirt roads or hiking from Khondowe.", africa, africanGreatLakes, easy, "Water Bottle, Sunglasses, Sunscreen, Hat or Visor", "One Day");
        trekRepo.save(livingstonia);


//      Continent:Australia
        Trek larapintaTrail = new Trek("Larapinta Trail", "One-way walk; good road access along track, including at ends", australia, northernTerritory, difficult, "Backpack, Walking Stick, Sleeping bag, Head lamp, Waterproof climbing shoes, Hat or visor, sunscreen.", "Eleven to fifteen days.");
        trekRepo.save(larapintaTrail);

        Trek fraserIslandGreatWalk = new Trek("Fraser Island Great Walk", "One is a spectacular World Heritage area, with pristine lakes, rare rainforests growing on sand.", australia, tasmaniaHobart, easy,"Backpack, Walking Stick, Sleeping bag, Hat or visor, sunscreen.", "Three to five days");
        trekRepo.save(fraserIslandGreatWalk);

        Trek wildernessCoastWalk = new Trek("Wilderness Coast Walk", " One-way; boat transport required at one end, road access at other", australia, victoriaMelbourne, moderate, "Five to seven days", "Backpack, Walking Stick, Sleeping bag, Head lamp, Waterproof climbing shoes, Hat or visor, sunscreen.");
        trekRepo.save(wildernessCoastWalk);


//      Continent: Europe
        Trek tourDeMontBlanc = new Trek("Tour De Mont Blanc", " This mother of all treks circumnavigates the mighty slopes of the highest mountain in the Alps", europe,france, difficult,"Backpack, Walking Stick, Sleeping bag, Head lamp, Waterproof climbing shoes.","ten to fifteen days");
        trekRepo.save(tourDeMontBlanc);

        Trek norwegianFjords = new Trek("Norwegian Fjords", "Take the family on treks over blue glaciers, viewing mountains that come straight up from the narrow fjords.",europe, northernTerritory, easy, "Water Bottle, Sunglasses, Sunscreen, Hat or Visor","One day");
        ...
        Trek canaryIslands = new Trek("Canary Islands", "Enerife boasts the world’s 3rd highest volcano, pine forests, ravines and coastal paths.", europe, iberianPeninsula, easy, "Backpack, Walking Stick, Sleeping bag, Head lamp, Waterproof climbing shoes.", "Two to three days.");
...
//      Continent: South America
        ...
        Trek theIncaTrail = new Trek("The Inca Trail", "When you think of trekking in South America, you think of the Inca Trail", southAmerica, brazilianCoastline, moderate, "Water Bottle, Sleeping bag or tent, Sunglasses, Sunscreen, Hat or Visor", "Three to five days");
        trekRepo.save(theIncaTrail);

        Trek theLostCity = new Trek("The Lost City", "Colombia’s Inca Trail, the Lost City trek is the country’s best multi-day trekking option.", southAmerica, amazon, moderate, "Water Bottle, Sleeping bag or tent, Sunglasses, Sunscreen, Hat or Visor.", "Three to Five days");
...
//      Continent: North America
        ...
        Trek theAppalachianTrail = new Trek("The Appalachian Trail", "The Appalachian Trail is a 2,180+ mile long public footpath that traverses the scenic, wooded, pastoral, wild, and culturally resonant lands of the Appalachian Mountains.", northAmerica, variedEasternRegion, strenuous, "Water Bottle, Sleeping bag, Sunglasses, Sunscreen, Hat or Visor, Hunting Knife, Firearm.", "One to three months");
