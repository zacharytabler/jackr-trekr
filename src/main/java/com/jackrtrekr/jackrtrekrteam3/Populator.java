...
//      Continent: Europe
        ...
        Trek tourDeMontRosa = new Trek("Tour De Mont Rosa", "The trek around this 15710 foot mountain is stunning - and it is not easy. Every day there are steep ascents and descents over ice and rock.", europe, italianPeninsula, difficult,"Backpack, Walking Stick, Sleeping bag, Head lamp, Waterproof climbing shoes.", "Eleven to fifteen days", "Hardest thing I have ever done!");
        trekRepo.save(tourDeMontRosa);

        Trek canaryIslands = new Trek("Canary Island", "Enerife boasts the world’s 3rd highest volcano, pine forests, ravines and coastal paths.", europe, spain, easy, "Backpack, Walking Stick, Sleeping bag, Head lamp, Waterproof climbing shoes.", "Two to three days.", "Its was awesome!");
