...
//        Continent: Asia
        ...
        Trek shamanseerMountain = new Trek("Shamanseer Mountain", "/images/Shamanseer Mountain.jpg", "This is a very light trail that will only take about 2-3 days to complete. Hikers will walk a total of 65 miles over. Heights will reach up to 5500 feet. The path is pretty rocky.", asia, southwestAsia, easy, "Water Bottle, Sleeping bag, Sunglasses, Sunscreen, Hat or Visor", "Two to Three days.");
        ...
        Trek theOceanEndeavour = new Trek("The Ocean Endeavour", "/images/Mount Vinson.jpg", "Explore the natural environment and closeup encounters with wildlife on our forward-facing zodiac’s and on foot.", antarctica, southPole, difficult, "Raft, Water bottle, Food, Head Lamp", "Eleven days");
        trekRepo.save(theOceanEndeavour);

        //      Continent: Africa
        Trek mountKilimanjaro = new Trek ("Mount Kilimanjaro", "/images/Mount Kilimanjaro (small).jpg", "The highest mountain in Africa—rising to 5,895 more than 19,000 feet in elevation.", africa, savanna, moderate, "Water Bottle, Sleeping bag, Sunglasses, Sunscreen, Hat or Visor","Three to Five days");
        trekRepo.save(mountKilimanjaro);

        Trek maasaiMara = new Trek("Maasai Mara.", "/images/Maasai Mara (small).jpg", "The Maasai Mara offers several cross-counrty tours. It is all across flat lands.", africa, southernAfrica, moderate,"Water Bottle, Sleeping bag, Sunglasses, Sunscreen, Hat or Visor", "Five to seven days");
        trekRepo.save(maasaiMara);

        Trek blydeRiverCanyon = new Trek("Blyde River Canyon","/images/Blyde River Canyon (small).jpg",  "This lush valley is the third-largest canyon in the world, and is marked by a clear, blue river cutting through sheer stone drop-offs 800 meters high.", africa, southernAfrica, strenuous, "Water Bottle, Sleeping bag, Sunglasses, Sunscreen, Hat or Visor, Hunting Knife", "Twenty Days");
        trekRepo.save(blydeRiverCanyon);

        Trek danakilDepression = new Trek("Danakil Depression",  "/images/Danakil Depression (small).jpg","The Danakil Depression is one of the most inhospitable places on the planet, and yet life flourishes here. The Afar people thrive here.", africa, ethiopianHighlands, moderate, "Water Bottle, Sleeping bag, Sunglasses, Sunscreen, Hat or Visor, Head Lamp", "One day and One Night");
...
//      Continent:Australia
        Trek larapintaTrail = new Trek("Larapinta Trail", "/images/Larapinta-Trail.jpg", "One-way walk; good road access along track, including at ends", australia, northernTerritory, difficult, "Backpack, Walking Stick, Sleeping bag, Head lamp, Waterproof climbing shoes, Hat or visor, sunscreen.", "Eleven to fifteen days.");
        trekRepo.save(larapintaTrail);

        Trek fraserIslandGreatWalk = new Trek("Fraser Island Great Walk", "/images/Fraser Island Great Walk (small).jpg", "One is a spectacular World Heritage area, with pristine lakes, rare rainforests growing on sand.", australia, tasmaniaHobart, easy,"Backpack, Walking Stick, Sleeping bag, Hat or visor, sunscreen.", "Three to five days");
        trekRepo.save(fraserIslandGreatWalk);

        Trek wildernessCoastWalk = new Trek("Wilderness Coast Walk", "/images/wildernesscoast.jpg", "One-way; boat transport required at one end, road access at other", australia, victoriaMelbourne, moderate, "Five to seven days", "Backpack, Walking Stick, Sleeping bag, Head lamp, Waterproof climbing shoes, Hat or visor, sunscreen.");
        trekRepo.save(wildernessCoastWalk);


//      Continent: Europe
        Trek tourDeMontBlanc = new Trek("Tour De Mont Blanc", "/images/tour du mont blanc (small).jpg", "This mother of all treks circumnavigates the mighty slopes of the highest mountain in the Alps", europe,france, difficult,"Backpack, Walking Stick, Sleeping bag, Head lamp, Waterproof climbing shoes.","ten to fifteen days");
        ...
        Trek canaryIslands = new Trek("Canary Islands",  "/images/Canary Islands.jpg","Enerife boasts the world’s 3rd highest volcano, pine forests, ravines and coastal paths.", europe, iberianPeninsula, easy, "Backpack, Walking Stick, Sleeping bag, Head lamp, Waterproof climbing shoes.", "Two to three days.");
        trekRepo.save(canaryIslands);


//      Continent: South America
        Trek chapadaDiamantinaNationalPark = new Trek("Chapada Diamantina National Park", "/images/Chapada Diamantina (small).jpg", "One of the most beautiful National Parks in Brazil, Chapada Diamantina is located in Bahia in northeast Brazil", southAmerica, brazilianCoastline, moderate, "Water Bottle, Sleeping bag, Sunglasses, Sunscreen, Hat or Visor", "Two to five days");
        trekRepo.save(chapadaDiamantinaNationalPark);

        Trek theIncaTrail = new Trek("The Inca Trail","/images/Inca Trail (small).jpg",  "When you think of trekking in South America, you think of the Inca Trail", southAmerica, brazilianCoastline, moderate, "Water Bottle, Sleeping bag or tent, Sunglasses, Sunscreen, Hat or Visor", "Three to five days");
        trekRepo.save(theIncaTrail);

        Trek theLostCity = new Trek("The Lost City", "/images/Lost City Trek (small).jpg", "Colombia’s Inca Trail, the Lost City trek is the country’s best multi-day trekking option.", southAmerica, amazon, moderate, "Water Bottle, Sleeping bag or tent, Sunglasses, Sunscreen, Hat or Visor.", "Three to Five days");
        trekRepo.save(theLostCity);


//      Continent: North America
        Trek yellowstone = new Trek("Yellowstone Park", "/images/Yellowstone (small).jpg", "Yellowstone National Park in Wyoming, Montana and Idaho is a hiker's paradise, with approximately 1,000 miles of hiking trails across more than 2.2 million acres.", northAmerica, mountainousWest, difficult, "Five to Seven days", "Water Bottle, Sleeping bag or tent, Sunglasses, Sunscreen, Hat or Visor");
        trekRepo.save(yellowstone);

        Trek grandTetonNationalPark = new Trek("Grand Teton National Park", "/images/Grand Teton (small).jpg", "The park, which sits in Wyoming's Jackson Hole valley, caters to every level of hiker with its more than 200 miles of trails", northAmerica, greatPlains, moderate,"Water Bottle, Sleeping bag or tent, Sunglasses, Sunscreen, Hat or Visor", "One to five days");
        trekRepo.save(grandTetonNationalPark);

        Trek theAppalachianTrail = new Trek("The Appalachian Trail", "/images/Appalachian Trail (small).jpg", "The Appalachian Trail is a 2,180+ mile long public footpath that traverses the scenic, wooded, pastoral, wild, and culturally resonant lands of the Appalachian Mountains.", northAmerica, variedEasternRegion, strenuous, "Water Bottle, Sleeping bag, Sunglasses, Sunscreen, Hat or Visor, Hunting Knife, Firearm.", "One to three months");
